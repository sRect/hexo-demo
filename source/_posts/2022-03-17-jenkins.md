...
![add secrets](/assets/img/jenkins-docker/add-secrets.jpg)
...
![workflows](/assets/img/jenkins-docker/workflows.jpg)

镜像也成功推送到 dockerhub 了

![myjebkins](/assets/img/jenkins-docker/myjebkins.jpg)
...
![](/assets/img/jenkins-docker/jenkens-init.jpg)

2. 初始化结束后，需要解锁 Jenkins

![](/assets/img/jenkins-docker/jenkins-unlock.jpg)
...
![](/assets/img/jenkins-docker/jenkins-plugin.jpg)

点击左侧*安装推荐的插件*，过一会，等插件安装好

![](/assets/img/jenkins-docker/jenkins-plugins-install.jpg)

4. 注册管理员账号

按着提示一步步来操作

![](/assets/img/jenkins-docker/jenkins-admin.jpg)

5. 最终进入 jenkins 首页，表示安装成功了

![](/assets/img/jenkins-docker/jenkins-welcome.jpg)
...
![](/assets/img/jenkins-docker/jenkins-plugin-nodejs.png)
...
![](/assets/img/jenkins-docker/jenkins-global-plugin.jpg)
...
![](/assets/img/jenkins-docker/github-webhook.jpg)

#### 5.3 正式部署前端项目

1. jenkins 左侧菜单点击`新建任务`，输入任务名称，选择`构建一个自由风格的软件项目`，点击确定

![](/assets/img/jenkins-docker/jenkins-firsttask.jpg)

2. 创建

![](/assets/img/jenkins-docker/jenkins-task-1.jpg)

3. 源码管理

![](/assets/img/jenkins-docker/jenkins-task-2.jpg)
...
![](/assets/img/jenkins-docker/jenkins-task-3.jpg)

5. 构建环境

这里是选择项目需要的 nodejs 版本，nodejs 的版本就按着前面所说的添加

![](/assets/img/jenkins-docker/jenkins-task-4.jpg)

6. 构建-执行 shell

![](/assets/img/jenkins-docker/jenkins-task-5.jpg)
...
![](/assets/img/jenkins-docker/jenkins-console.jpg)

8. 我们可以随便修改下前端代码，然后提交代码，测试是否会自动构建

![](/assets/img/jenkins-docker/jenkins-github-hook-log.jpg)
